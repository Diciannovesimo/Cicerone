                        ...
                        public void onComplete(@NonNull Task<AuthResult> task)
                        {
                            if (task.isSuccessful())
                            {
                                ...
                                AuthenticationManager.get().sendVerificationEmail(new OnCompleteListener<Void>()
                                {
                                    ...
                                    {
                                        if(task.isSuccessful())
                                            ;   // TODO: Aggiungete un messaggio di notifica tramite toast (by Luca)
                                        else
                                            ;   // TODO: Aggiungete un messaggio di errore (by Luca)
                                    }
                                });
                            ...
                            {
                                /*
                                        TODO: Mostrare un messaggio di errore diverso per questo caso,
TODO:                                         testando non sono riuscito a capire di che errore si trattasse
TODO:                                         senza guardare il codice! (by Luca)
                                 */
    ...
    private boolean checkFields()
    {
        ...
        {
            fragment1.getEmailField().setError("Campo non valido!");  // TODO: Replace with an R.string (by Luca)
            alright = false;
        }
        ...
        {
            fragment1.getPasswordField().setError("Password troppo corta!");  // TODO: Replace with an R.string (by Luca)
            alright = false;
        }

        if(fragment1.getConfpassField().getText().toString().equals(fragment1.getConfpassField().getText().toString()) == false)
        {
            fragment1.getConfpassField().setError("Password troppo corta!");  // TODO: Replace with an R.string (by Luca)
            alright = false;
        }
        ...
        {
            fragment2.getNameField().setError("Nome non valido!");  // TODO: Replace with an R.string (by Luca)
            alright = false;
        }
        ...
        {
            fragment2.getSurnameField().setError("Cognome non valido!");  // TODO: Replace with an R.string (by Luca)
            alright = false;
        }
        ...
        {
            fragment2.getDate_birthField().setError("Il campo è obbligatorio!");  // TODO: Replace with an R.string (by Luca)
            alright = false;
        }
