...
public class RegistrationActivity extends AppCompatActivity {
    ...
    public void startRegistration(View view) {
        ...
        if(checkFields())
        {
            createFirebaseUser(fragment1.getEmailField().getText().toString(), fragment1.getPasswordField().getText().toString() );
        }
        else
        {
            showDialog(false);
    ...
    private boolean checkFields()
    {
        ...
        //Check email
        if(fragment1.getEmailField().toString().trim().matches(EMAIL_REGEX))
            alright = false;
        ...
        if(fragment1.getConfpassField().getText().toString().equals(fragment1.getConfpassField().getText().toString()) == false)
            alright = false;
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            //TODO: Mettere un cazzo di timer perchè l'animazione non si vede più tutta
